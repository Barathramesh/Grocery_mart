            ...
            <div key={index} className='border border-gray-300 rounded-lg mb-10 p-4 py-5 max-w-4xl'>
               ...
               max-md:flex-col'>
                 ...
                 {order.items.map((item,index)=>(
                     ...
                     border-gray-300 flex flex-col md:flex-row md:item-center justify-between p-4 py-5 md:gap-16 w-full max-w-4xl`}>
                        ...
                        <p className='text-primary text-lg font-medium'>
                          Amouny: {currency}{item.product.offerPrice * item.quantity}
                        </p>
                     </div>    
                 ))}
